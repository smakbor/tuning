...
export default function DisabledPickers() {
  ...
  const disabledDatepickerCodeString = `<LocalizationProvider dateAdapter={AdapterDayjs}>
  <DatePicker
    disabled
    value={value}
    onChange={(newValue) => {
...
<LocalizationProvider dateAdapter={AdapterDayjs} localeText={{ start: 'disabled start', end: 'disabled end' }}>
  <DateRangePicker
    disabled
    value={valueRange}
    onChange={(newValue) => {
...
<LocalizationProvider dateAdapter={AdapterDayjs} localeText={{ start: 'read-only start', end: 'read-only end' }}>
  <DateRangePicker
    readOnly
    value={valueRange}
    onChange={(newValue) => {
