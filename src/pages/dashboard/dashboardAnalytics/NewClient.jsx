...
const NewClient = ({ color = 'primary', id, totalDue, totalBill, totalBalance, title, count, percentage, isLoss, extra, amountColor }) => (
  <MainCard
    contentSX={{
      p: 2.25
    }}
  ...
  >
    <Stack spacing={0.5}>
      <Typography variant="h5" color={amountColor || 'inherit'}>
        <Box sx={{ color: 'white', display: 'inline-block', px: 1, bgcolor: '#ff5722', borderRadius: 1 }}>
          {title} {count}
        </Box>
      </Typography>
