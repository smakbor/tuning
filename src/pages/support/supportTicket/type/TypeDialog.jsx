...
const TypeDialog = ({
  ...
  const formSubmit = (formValue) => {
    isUpdate ? handleSupportTypeUpdate({ formValue, setError, reset }) : handleTypeCreate({ formValue, setError, reset });
  };
...
TypeDialog.propTypes = {
  handleTypeCreate: PropTypes.func,
  handleTypeUpdate: PropTypes.func,
  ...
  handleSupportTypeUpdate: PropTypes.func,
