...
const FooterBlock = ({ isFull }) => {
  ...
  const frameworks = [
    ...
    {
      title: 'Bootstrap 5',
      link: 'https://codedthemes.com/item/root-billing-bootstrap-admin-dashboard/'
    },
    {
      title: '.Net',
              ...
              <Grid container spacing={{ xs: 5, md: 2 }}>
                ...
                <Grid item xs={6} sm={3}>
                  <Stack spacing={{ xs: 3, md: 5 }}>
                    ...
                    <Stack spacing={{ xs: 1.5, md: 2.5 }}>
                      <FooterLink href="https://netfee.com" target="_blank" underline="none">
                        Netfee
                      </FooterLink>
                      <FooterLink href="https://hisabnikashbd.com/" target="_blank" underline="none">
                        Hishab Nikash
                      </FooterLink>
                    </Stack>
                  </Stack>
